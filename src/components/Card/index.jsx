...
const Card = () => {
  return (
    <CardContainer>
        ...
        <Content>
            <UserInfo>
                <UserPicture src='https://avatars.githubusercontent.com/u/161047430?v=4' />
                <div>
                    <h4>Mariana Cruz</h4>
                    <p>Há 8 minutos</p>
                </div>
            ...
            <PostInfo>
                <h4>Projeto para curso react native</h4>
                <p>Projeto feito no curso de react native no bootcamp da dio do Global avanade...<strong>Saiba Mais</strong></p>
            </PostInfo>
            <HasInfo>
                <h4>#HTML #CSS #JavaScript <div id="React"></div></h4>
                <p>
                    <FiThumbsUp /> 16
                </p>
            </HasInfo>
